...
def consolidate_data(data_frames):
    """
    Consolide plusieurs DataFrames prise en entrée en une seule, supprime 
    les doublons et sauvegarde le résultat dans un fichier CSV.
    """
    if not data_frames:
    ...
    consolidated_data.to_csv('../outputs/consolidated_inventory.csv'
                             , index=False)
